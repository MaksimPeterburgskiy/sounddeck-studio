/* @ts-self-types="./deep_filter.d.ts" */
 ...
 * @returns {number}
 */
export function df_get_input_ptr(st) {
    const ret = wasm.df_get_input_ptr(st);
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function df_get_output_ptr(st) {
    const ret = wasm.df_get_output_ptr(st);
    return ret >>> 0;
}
 ...
 * @returns {any}
 */
export function df_memory() {
    const ret = wasm.df_memory();
    return ret;
}
 ...
 * @returns {number}
 */
export function df_process_frame(st) {
    const ret = wasm.df_process_frame(st);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        throw new Error('DeepFilterNet WASM bytes are required');
    }
    const imports = __wbg_get_imports();
